...
public class SecurityTransaction_Module {
	...
	public void SecurityTransaction() throws MalformedURLException, InterruptedException
	{
	    ...
	    //////////..........Amount..........///////////
	    driver.findElement(By.id("com.ambs.mobile:id/etAmount_P_SecurityTransaction")).sendKeys("200"); //amount 
	    Thread.sleep(2000);
	    
	    ///////////...Description......///////
	    driver.findElement(By.id("com.ambs.mobile:id/etDescription_P_SecurityTransaction")).sendKeys("nill"); //description
	    Thread.sleep(2000);
